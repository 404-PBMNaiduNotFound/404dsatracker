  ...
  head: () => ({
    meta: [
      { title: "DSA⁴⁰⁴" },
      {
        name: "description",
        content:
          "Finish the Core 404 DSA roadmap in 120 days. Daily problem checklists, AI mentor, cloud-synced progress, and a schedule that reshapes itself when life happens.",
      },
    ...
    <section className="relative overflow-hidden py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-5xl px-4">
        <p className="mb-4 font-mono text-xs tracking-[0.2em] text-primary uppercase">
          Core 404 · 338 problems · 42 topics · 120 days
        </p>
  ...
  return (
    <div className="mt-4 font-mono text-xs space-y-2">
      <div className="grid grid-cols-2 gap-2 mb-1">
        {[
          { label: "Total", val: "838", color: "text-primary" },
          { label: "Verified links", val: "338+", color: "text-green-500" },
        ].map((s) => (
